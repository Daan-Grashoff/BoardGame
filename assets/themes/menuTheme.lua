...
Menu.startLocalButton.draw = function(self)
    ...
    love.graphics.print('Start local', self.x + 90, self.y + 17, 0, scale)
...
Menu.startMultiButton.draw = function(self)
    ...
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    love.graphics.setColor(255, 255, 255)
    love.graphics.print('Start multiplayer', self.x + 75, self.y + 17, 0, scale)
    if self.selected then
        love.graphics.setColor(128, 32, 32)
        love.graphics.rectangle('line', self.x, self.y, self.w, self.h)
    end
...
Menu.ResumeButton.draw = function(self)
    ...
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    love.graphics.setColor(255, 255, 255)
    love.graphics.print('Resume Game', self.x + 220, self.y + 17, 0, scale)
    if self.selected then
        love.graphics.setColor(128, 32, 32)
        love.graphics.rectangle('line', self.x, self.y, self.w, self.h)
    end
...
Menu.CreditsButton.draw = function(self)
    ...
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    love.graphics.setColor(255, 255, 255)
    love.graphics.print('Credits', self.x + 240, self.y + 17, 0, scale)
    if self.selected then
        love.graphics.setColor(128, 32, 32)
        love.graphics.rectangle('line', self.x, self.y, self.w, self.h)
    end
...
Menu.HelpButton.draw = function(self)
    ...
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    love.graphics.setColor(255, 255, 255)
    love.graphics.print('Help', self.x + 250, self.y + 17, 0, scale)
    if self.selected then
        love.graphics.setColor(128, 32, 32)
        love.graphics.rectangle('line', self.x, self.y, self.w, self.h)
    end
...
Menu.QuitButton.draw = function(self)
    ...
    love.graphics.rectangle('fill', self.x, self.y, self.w, self.h)
    love.graphics.setColor(255, 255, 255)
    love.graphics.print('Quit', self.x + 250, self.y + 17, 0, scale)
    if self.selected then
        love.graphics.setColor(128, 32, 32)
        love.graphics.rectangle('line', self.x, self.y, self.w, self.h)
    end
