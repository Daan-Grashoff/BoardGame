-- Meta Class
MountainTile = { id, color, boardSize, image, size, type, f}
MountainTile.__index = MountainTile

-- constructor
function MountainTile:new(id, color, boardSize, image, size, type, f)
  self = setmetatable( {}, MountainTile )
  self.m_id = id
...
function MountainTile:load()
  self.l1 = love.graphics.newImage('assets/images/mountain/l1.png')
  self.l2 = love.graphics.newImage('assets/images/mountain/l2.png')
  self.l3 = love.graphics.newImage('assets/images/mountain/l3.png')
  self.m1 = love.graphics.newImage('assets/images/mountain/m1.png')
  self.m2 = love.graphics.newImage('assets/images/mountain/m2.png')
  self.m3 = love.graphics.newImage('assets/images/mountain/m3.png')
  self.r1 = love.graphics.newImage('assets/images/mountain/r1.png')
  self.r2 = love.graphics.newImage('assets/images/mountain/r2.png')
  self.r3 = love.graphics.newImage('assets/images/mountain/r3.png')
end

function MountainTile:onPress()
  self.selected = true
  print(self.m_type)
end

function MountainTile:draw()
