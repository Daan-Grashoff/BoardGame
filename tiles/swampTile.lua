-- Meta Class
SwampTile = { id, color, boardSize, image, size, type, f}
SwampTile.__index = SwampTile

-- constructor
function SwampTile:new(id, color, boardSize, image, size, type, f)
  self = setmetatable( {}, SwampTile )
  self.m_id = id
...
function SwampTile:load()
  self.l1 = love.graphics.newImage('assets/images/swamp/l1.png')
  self.l2 = love.graphics.newImage('assets/images/swamp/l2.png')
  self.l3 = love.graphics.newImage('assets/images/swamp/l3.png')
  self.m1 = love.graphics.newImage('assets/images/swamp/m1.png')
  self.m2 = love.graphics.newImage('assets/images/swamp/m2.png')
  self.m3 = love.graphics.newImage('assets/images/swamp/m3.png')
  self.r1 = love.graphics.newImage('assets/images/swamp/r1.png')
  self.r2 = love.graphics.newImage('assets/images/swamp/r2.png')
  self.r3 = love.graphics.newImage('assets/images/swamp/r3.png')
end

function SwampTile:onPress()
  self.selected = true
  print(self.m_type)
end

function SwampTile:draw()
