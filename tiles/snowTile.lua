-- Meta Class
SnowTile = { id, color, boardSize, image, size, type, f}
SnowTile.__index = SnowTile

-- constructor
function SnowTile:new(id, color, boardSize, image, size, type, f)
  self = setmetatable( {}, SnowTile )
  self.m_id = id
  ...
  elseif f == 'lt' then
    self.f = {
      {Image = self.l1, X = (5 + offsetX), Y = offsetY, Scale = (self.m_size / 32)},
...
function SnowTile:load()
  self.l1 = love.graphics.newImage('assets/images/snow/l1.png')
  self.l2 = love.graphics.newImage('assets/images/snow/l2.png')
  self.l3 = love.graphics.newImage('assets/images/snow/l3.png')
  self.m1 = love.graphics.newImage('assets/images/snow/m1.png')
  self.m2 = love.graphics.newImage('assets/images/snow/m2.png')
  self.m3 = love.graphics.newImage('assets/images/snow/m3.png')
  self.r1 = love.graphics.newImage('assets/images/snow/r1.png')
  self.r2 = love.graphics.newImage('assets/images/snow/r2.png')
  self.r3 = love.graphics.newImage('assets/images/snow/r3.png')
end

function SnowTile:onPress()
  self.selected = true
  print(self.m_type)
end

function SnowTile:draw()
